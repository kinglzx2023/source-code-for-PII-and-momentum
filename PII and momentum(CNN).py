...
name = 'lr_'+'batch_size:'+str(Batch_size)+'_learning_rate:'+ str(learning_rate)  + '_random_seed :'+ str(random_seed )
...
for epoch in range(num_epochs):
    ...
    file1.writelines(f'Epoch [{epoch + 1}/{num_epochs}], Loss: {train_loss:.4f}, Train Accuracy: {train_accuracy:.4f}, Test Accuracy: {test_accuracy:.4f}'+'\n')
